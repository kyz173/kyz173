...
def inference(image):
    ...
    #cmap, paf = cmap.detach().gpu(), paf.detach().gpu()
...
if WRITE2CSV:
    ...
    save_name = activity[0:-4] #remove .avi
    dataFile = open('data/{}.csv'.format(save_name),'w')
...
while True:
    ...
    if ret:
        ...
        info = "FPS: " + str(round((1000/(1000*exec_time)),1))
        print(info)
